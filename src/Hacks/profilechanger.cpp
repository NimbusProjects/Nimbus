...
int Settings::ProfileChanger::coinID = 874; //890
int Settings::ProfileChanger::musicID = 20140; //10
int Settings::ProfileChanger::compRank = 16; //18
int Settings::ProfileChanger::weaponStatus = 0; //???
int Settings::ProfileChanger::weaponRarity = 0; //??? don't know yet
